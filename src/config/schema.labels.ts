...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.toolSearchCodeMode": "Tool Search Code Mode",
  "tools.toolSearchCodeMode.enabled": "Enable Tool Search Code Mode",
  "tools.toolSearchCodeMode.mode": "Tool Search Surface",
  "tools.toolSearchCodeMode.includeOpenClawTools": "Catalog OpenClaw Tools",
  "tools.toolSearchCodeMode.includeMcpTools": "Catalog MCP Tools",
  "tools.toolSearchCodeMode.includeClientTools": "Catalog Client Tools",
  "tools.toolSearchCodeMode.codeTimeoutMs": "Code Timeout",
  "tools.toolSearchCodeMode.searchDefaultLimit": "Default Search Limit",
  "tools.toolSearchCodeMode.maxSearchLimit": "Max Search Limit",
